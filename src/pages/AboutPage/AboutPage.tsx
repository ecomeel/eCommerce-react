...
export const AboutPage: React.FC = () => {
    return (
        <div className="about">
            ...
            <p>Ducimus, optio corporis? Rerum rem vitae ipsa ut quae sed eaque iusto repudiandae distinctio, voluptas enim ratione deleniti, harum dolores consequatur. Accusantium quia eaque molestiae corporis, iste quaerat. Corporis, asperiores.</p>
            <p>Amet necessitatibus quasi voluptatem nemo? Enim voluptate et maiores nemo at recusandae ratione non amet suscipit. Sed iusto inventore placeat modi eveniet debitis pariatur unde dolores iure in, esse dolorem?</p>
        </div>
    );
};
